...
import type { ISessionService } from 'src/session/session'
...
import type { IUsersService } from 'src/users/users'
import type { IForgotPasswordService } from 'src/forgot-password/forgot-password'
import type { IMailsService } from 'src/mails/mails'
...
export class AuthService implements IAuthService {
  ...
  async validateSocialLogin(authProvider: AuthProvidersEnum, socialData: SocialType): Promise<LoginResponseType> {
    ...
    if (user) {
      ...
      user = await this.usersService.createUser({
        ...
        password: randomStringGenerator() // Temporary password, not used
      })
